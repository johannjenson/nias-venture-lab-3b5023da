...
const EventSEO = () => {
  return (
    <Helmet>
      <title>Capital & Culture: Structuring the Future of Cities | Private Summit in Riyadh</title>
      <meta name="description" content="Join us for an exclusive evening on November 18 during Cityscape Riyadh. Keynote by Mark Wadhwa (180 Studios), expert panels on creative placemaking and cross-border real estate structuring, followed by dinner and roundtables for global investors, developers, and advisors." />
      <meta property="og:title" content="Capital & Culture: Structuring the Future of Cities | Nov 18, Riyadh" />
