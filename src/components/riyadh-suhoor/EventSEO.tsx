...
const EventSEO = () => {
  return (
    <Helmet>
      ...
      <meta property="og:url" content="https://nias.io/gatherings/riyadh-suhoor-dinner" />
      <meta property="og:image" content="https://nias.io/nias-og-image.png" />
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content="NIAS Private Suhoor Dinner · Riyadh" />
      <meta name="twitter:description" content="Invitation-only Suhoor dinner for senior leaders in Riyadh, March 3 2026." />
