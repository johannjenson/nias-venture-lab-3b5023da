    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
          NIAS hosts a small group of senior guests for a private Suhoor dinner in Riyadh at the start of Ramadan. The evening arrives just before the city enters one of its busiest international seasons.
        </p>
