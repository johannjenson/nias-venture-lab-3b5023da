...
const EventSEO = () => {
  return (
    <Helmet>
      <title>The Playbook for Landing & Expanding in Saudi Arabia | NIAS Panel at Doers Summit Dubai</title>
      <meta name="description" content="Join NIAS at Doers Summit Dubai on November 26th for a panel discussion on expanding into the GCC and Saudi Arabia. Featuring industry leaders from Tap Payments, palm.hr, and The Saudi Times." />
      <meta property="og:title" content="The Playbook for Landing & Expanding in Saudi Arabia" />
