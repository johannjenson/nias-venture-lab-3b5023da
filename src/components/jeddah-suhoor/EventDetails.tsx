    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
          On the eve of Ramadan, NIAS gathers a small group of senior decision-makers for a private Suhoor dinner on the Red Sea coast. The evening is designed for unhurried dialogue — the kind of conversation that only happens when the table is the right size and the guest list is carefully composed.
        </p>
      ...
      <div className="mt-8">
        ...
        <div className="flex items-center gap-10 flex-wrap">
          <a href="https://www.the-diwan.com/" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
            <img src={diwanLogo} alt="The Diwan" className="h-32 w-auto" />
          </a>
          <div>
