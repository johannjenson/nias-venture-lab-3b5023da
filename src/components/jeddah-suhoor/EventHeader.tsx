...
import heroImage from "@/assets/jeddah-suhoor-hero.jpg";
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="order-2 lg:order-1">
              <div className="relative">
                <img
                  src={heroImage}
                  alt="Jeddah Suhoor Dinner — NIAS Private Gathering"
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-xs uppercase tracking-[0.2em] text-primary/70 font-medium mb-3">
                Jeddah · Wednesday, 4 March 2026
              </p>

              <h1 className="text-4xl lg:text-5xl font-bold tracking-tight text-primary mb-5 animate-fade-in leading-tight">
                A Private Suhoor Dinner<br className="hidden lg:block" /> by Abdul Latif Jameel x NIAS
              </h1>
