...
const EventSEO = () => {
  return (
    <Helmet>
      <title>Canvases & Capital: Art & Wealth in the New KSA - Exclusive Event in Riyadh</title>
      ...
      <meta property="og:title" content="Canvases & Capital: Art & Wealth in the New KSA" />
      ...
      <meta name="twitter:title" content="Canvases & Capital: Art & Wealth in the New KSA" />
