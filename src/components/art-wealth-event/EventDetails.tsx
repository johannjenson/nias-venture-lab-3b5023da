...
const EventDetails = () => {
  return (
    <div>
      <h2 className="text-3xl font-bold text-primary mb-6">Join us for an evening where contemporary Saudi art meets wealth management in the lead-up to the 9th Future Investment Initiative — and discover how you can be part of the Kingdom's creative renaissance.</h2>
