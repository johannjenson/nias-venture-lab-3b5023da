...
const EventSEO = () => {
  return (
    <Helmet>
      <title>Informal Night Cap at The Greek Villa - Private Gathering for Innovators | Riyadh</title>
      <meta name="description" content="Join us for an Informal Night Cap at The Greek Villa, an exclusive evening gathering on October 27-28, 2025. Hosted by The Diwan (Saad Altami) and Nias.io (Johann Jenson), connecting innovators, changemakers, family offices, and diplomatic leaders." />
      <meta property="og:title" content="Informal Night Cap at The Greek Villa - Private Gathering for Innovators" />
