...
const EventSEO = () => {
  return (
    <Helmet>
      ...
      <meta name="description" content="Join us for an exclusive FII9 recap celebration on October 29th. Hosted by EAST40, Avra, and NTDP, featuring global innovation leaders including H.H. Prince Khalid Bin Bader Al Saud and Ibrahim Neaz." />
