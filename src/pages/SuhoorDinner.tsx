                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">9:00 PM - Guest arrival and networking</p>
                      <p className="text-gray-600">9:30 PM - Suhoor meal</p>
                      <p className="text-gray-600">1:00 AM - Event concludes</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
