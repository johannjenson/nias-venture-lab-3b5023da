...
export const aerospaceIndustry: Industry = {
  name: "Aerospace",
  score: 88,
  description: "Comprehensive development of aviation manufacturing capabilities, cutting-edge space technology programs including satellite development and launch services, alongside world-class aerospace research initiatives establishing Saudi Arabia as a key player in the global aerospace industry.",
